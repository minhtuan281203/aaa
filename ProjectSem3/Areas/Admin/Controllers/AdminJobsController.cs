...
namespace ProjectSem3.Areas.Admin.Controllers
{
    ...
    public class AdminJobsController : Controller
    {
        ...
        public AdminJobsController(AbcCvContext context)
        {
            _context = context;
        }
